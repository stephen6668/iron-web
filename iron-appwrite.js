  ...
  try {
    ...
    async function askAI(message) {
      ...
      if (execution.status === "failed") {
        throw new Error(execution.errors || "Appwrite Function ist fehlgeschlagen.");
      }
      ...
      try {
        ...
        throw new Error("Ungültige Antwort der Appwrite Function.");
      }

      if (!payload.ok) {
        throw new Error(payload.error || "IRON Cloud AI konnte nicht antworten.");
      }
