...
async function command(t){
  ...
  try{
    ...
    // Cloud fallback: currently records command so v18 stays online without PC.
    await cloud.create(cloud.cfg.tables.pcCommands,{command:t,status:"cloud",created_at:nowISO(),result:""});
    const a="IRON Cloud hat den Befehl empfangen. Für freie KI-Antworten fehlt nur noch die Appwrite Function.";
    show(a); speak(a);
